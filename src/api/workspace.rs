...
async fn get_current_collab_permission_handler(
  ...
  // Explicit collab permissions above override workspace role. If the current
  // user has no explicit collab row, use the workspace role even when this page
  // has been shared with other users.
